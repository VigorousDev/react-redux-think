...
class SocialBanner extends React.Component {
  ...
  render() {
    return (
      <div style={{height: 350, marginTop: -25, backgroundSize: 'cover', position: 'relative', marginBottom: 25, backgroundPosition: 'center'}}>
        ...
        <div className='social-avatar'>
          ...
          <h5 className='fg-white text-center' style={{opacity: 0.8}}>Assistant Director</h5>
